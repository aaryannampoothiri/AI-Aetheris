...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {/* Top Navigation */}
      <nav
        className="border-b border-white/10 bg-black/20 backdrop-blur-xl transition-all duration-300"
        style={{
        ...
        <div className="flex h-20 items-center justify-between pr-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              {showUserMenu && (
                <div className="absolute right-0 top-full mt-2 w-48 rounded-lg border border-white/10 bg-black/80 backdrop-blur-xl overflow-hidden z-[150]">
